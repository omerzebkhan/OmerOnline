...
import { fetchCashFlowAR,fetchCashFlowPay } from '../../redux/cashFlow/cashFlow.action';
            ...
            {access ?
                <div className="submit-form container">
                    ...
                    {currentUser ?
                        ...
                        : ""}
                    <h1>Cash Flow Accounts Receivable</h1>
...
const mapDispatchToProps = dispatch => ({
    ...
    fetchCashFlowAR: () => dispatch(fetchCashFlowAR())
});


export default connect(mapStateToProps, mapDispatchToProps)(CashFlowAR);