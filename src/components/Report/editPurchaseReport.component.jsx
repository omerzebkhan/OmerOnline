...
const EditPurchaseReport = ({
    ...
    fetchEditPurchase, editPurchaseData,
    currentUser
}) => {
    ...
    const [selectFilteredPurchase, setSelectFilteredPurchase] = useState([]);
    ...
    useEffect(() => {
        setFilteredPurchase(editPurchaseData)
    ...
    const handleSubmit = event => {
        ...
        fetchEditPurchase(startDate.toDateString(), endDate.toDateString(),item, inv);
        console.log(editPurchaseData)
    ...
    return (
        <div className="container">
            {access ?
                <div>
                    <div >
                        <div className="searchFormHeader"><h1>Purchase Edit Report</h1></div>
...
const mapStateToProps = state => ({
    ...
    purchaseInvoiceDetailData: state.sale.purchaseInvoiceDetail,
...
const mapDispatchToProps = dispatch => ({
    fetchEditPurchase: (sDate, eDate,itemId, invoiceId) => dispatch(fetchEditPurchase(sDate, eDate,itemId, invoiceId)),
