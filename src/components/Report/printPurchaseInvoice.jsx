  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View>
        ...
        <InvoiceTitle title='Purchase Invoice' />
...
const PrintPurchaseInvoice = ({ invoice, customer }) => {
  ...
  invoice.map((item, index) => {
    ...
    invoiceNo = item.purchaseInvoiceId;
    date = item.createdAt;
    return "";
  })
  ...
  return (
    <div className="App">
      ...
      />} fileName={invoiceNo + ".pdf"} >
        ...
        {({ blob, url, loading, error }) => (loading ? 'Loading document...' : 'Purchase Invoice Print')}
      </PDFDownloadLink>
    </div>
  );
}
