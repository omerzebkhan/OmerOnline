...
const SaleReturn = ({
    ...
    const [selectedSaleDetailData,setSelectedSaleDetaiData]=useState([]);
    ...
    useEffect(() => {
        setSelectedSaleDetaiData(saleInvoiceDetailData)
    ...
    const returnHandler = event => {
        ...
        //setSelectFilteredSale.Outstanding = selectedItem.Outstanding
        var count = 0;
        ...
        if (saleReturn.length === 0) { setMessage(`Select any value to return`) }
            ...
            saleReturn.map(async (item, index) => {
                ...
                if (saleReturn.length === index + 1) {
                    ...
                    ////////////hide Sales Invoice detailed view
                    
                    //saleInvoiceDetailData
                    // setInvoiceNo(selectedItem.saleInvoiceId);
                    // setSelectFilteredSale(selectedItem)
                    // fetchUserByInputAsync(selectedItem.customerId);
                    // fetchSaleInvoiceDetailAsync(selectedItem.saleInvoiceId);
                        ...
                        {selectedSaleDetailData ?
                            <div>
                                ...
                                <table id='returnTBL' border='1'>
                                    ...
                                    <tbody>
                                        {
                                            selectedSaleDetailData.map((item, index) => (
                                                //   console.log(item);
                                                <tr key={index}
